    ...
    <div className="Main-mtc-page">
      <div className="mtc-container">
        ...
        <div className="mtc-back-link-container">
          <Link href="/coworking/home" className="mtc-back-link">
        ...
        <div className="mtc-header-container">
          <div>
            ...
            <h2 className="mtc-page-subtitle">ห้องประชุมขนาดเล็ก (จำนวน {rooms.length} ห้อง)</h2>
          </div>
        ...
        <div className="mtc-room-grid"> {/* ตำแหน่ง card */}
          {rooms.map((room) => (
            <div key={room.Room_ID} className="mtc-room-card"> {/*รูปแบบcard*/}
              
              <div className="mtc-room-card-content"> {/*padding*/}

                <h4 className="mtc-room-name">{room.Room_Number}</h4> {/*ชื่อห้อง*/}
                <p className="mtc-room-description">{room.Description}</p> {/*เนื้อหา*/}
                
                <div className="mtc-room-details"> {/*จัดรูปแบบ*/}
                  <span>ความจุ: {room.Capacity} คน</span>
                  <span>ราคา: ฿{Number(calculatePrice(room.Price, selectedTimeSlot)).toFixed(0)}</span>
                </div>

                <div className="mtc-room-actions"> {/*จัดตำแหน่ง*/}
          ...
          <div className="mtc-modal-container">
            {!bookingSuccess ? (
              <>
                ...
                <div className="mtc-modal-actions">
                  <button
